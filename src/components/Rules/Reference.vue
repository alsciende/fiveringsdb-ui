<template>
    <div>
        <h2 id="Version">RULES REFERENCE</h2>
        <p>Version 1.01</p>
        ...
        <p>"<a hhref="#Stronghold">Stronghold</a>" on page 15</p>
        <hr>
        <h1 id="Intro">Rules Reference</h1>
        <p>
        ...
        <h1 id="The_Jade_Rule">The Jade Rule</h1>
        <p>
        ...
        <p><b>Related:</b> <a hhref="#Cost">Cost</a>,
            <a hhref="#Effects">Effects</a>,
            <a hhref="#Forced">Forced</a>,
            <a hhref="#Target">Target</a>,
            <a hhref="#Triggered_Abilities">Triggered Abilities</a></p>
        <h2 id="Action">Action, Action Ability</h2>
        <p>An action ability is a triggered card ability that contains the boldface "<b>Action:</b>" precursor. An action ability may be triggered by its controller during any action window (see <a
                hhref="#Appendix_I">"Appendix I: Timing and Gameplay"</a> on page 18).</p>
        <ul>
        ...
        <p><b>Related:</b> <a hhref="#Ability">Ability</a>,
            <a hhref="#Triggered_Abilities">Triggered Abilities</a></p>
        ...
        <h2 id="Attachment">Attachment Cards</h2>
        <p>
        ...
        <p>For attachment card anatomy, see "<a hhref="#Appendix_II">Appendix II: Card Anatomy</a>" on page 24.</p>
        <h2 id="Attacker">Attacker, Attacking Character, Attacking Player</h2>
        <p>
        ...
        <h2 id="Breaking_a_Province">Breaking a Province, Broken Province</h2>
        <p>
        ...
        <p>
            The game's cardtypes are: character, attachment, holding, event, province, stronghold, and role. Each of these cardtypes, with a detailed card anatomy, is presented in "<a
                hhref="#Appendix_II">Appendix II: Card Anatomy</a>" on page 24.</p>
        <ul>
            <li>
        ...
        <p>
            Some card abilities use the word "challenge" to initiate a duel between two characters participating in a conflict. For the rules on how to resolve a duel, see "<a
                hhref="#Duel_Timing">Duel timing</a>" on page 23.</p>
        <h2 id="Character">Character Cards</h2>
        <p>
        ...
        <p>For character card anatomy, see "<a hhref="#Appendix_II">Appendix II: Card Anatomy</a>" on page 24.</p>
        ...
        <p><b>Related:</b> <a hhref="#Target">Target</a></p>
        <h2 id="Clan">Clan</h2>
        ...
        <p><b>Related:</b> <a hhref="#Deckbuilding">Deckbuilding</a></p>
        ...
        <h2 id="Control_and_Ownership">Control and Ownership</h2>
        <p>
        ...
        <p>
            If a character has a dash (&ndash;) for a skill value, that character cannot participate in conflicts of that type.</p>
        <ul>
            <li>
            ...
            <li>
                A character with a dash skill value cannot be a challenger or challengee in a duel of that skill type. (see <a
                    hhref="#Duel_Timing">D.2</a> on page 23).
            </li>
        </ul>
        <p><b>Related:</b> <a hhref="#Participating">Participating and Cannot Participate</a></p>
        ...
        <h2 id="Deck_Limits">Deck Limits</h2>
        <p>
        ...
        <p>
            If a card has the text "Deck limit X" no more than X copies of that card may be included in that player's dynasty and/or conflict decks.</p>
        <ul>
        ...
        <h2 id="Defender">Defender, Defending Character, Defending Player</h2>
        <p>
        ...
        <h2 id="Dishonored">Dishonored, Dishonored Status Token</h2>
        <p>See "<a hhref="#Personal_Honor">Personal Honor</a>" on page 12.</p>
        ...
        <p><b>Related:</b> <a hhref="#Running_Out_of_Cards">Running Out of Cards</a></p>
        <h2 id="Duel">Duel</h2>
        <p>
        ...
        <p><b>Related:</b> <a hhref="#Unique">Unique</a></p>
        ...
        <p>For event card anatomy, see "<a hhref="#Appendix_II">Appendix II: Card Anatomy</a>" on page 24.</p>
        <h2 id="Facedown_Province">Facedown Province</h2>
        <p>
        ...
        <h2 id="First_Player">First Player, First Player Token</h2>
        <p>
        ...
        <p><b>Related:</b> <a hhref="#Active_Player">Active Player</a>,
            <a hhref="#Setup">Setup</a>,
            <a hhref="#Priority_of_Simultaneous_Resolution">Priority of Simultaneous Resolution</a>,
            <a hhref="#Appendix_I">Appendix I</a></p>
        <h2 id="Forced">Forced (Forced Interrupts, Forced Reactions)</h2>
        <p>
        ...
        <p><b>Related:</b> <a hhref="#Interrupts">Interrupts</a>,
            <a hhref="#Reactions">Reactions</a></p>
        <h2 id="Framework_Effects">Framework Effects and Framework Steps</h2>
        <p>
        ...
        <p><b>Related:</b> <a hhref="#Appendix_I">Appendix I</a></p>
        ...
        <p><b>Related:</b> <a hhref="#Printed">Printed</a></p>
        <h2 id="Give">Give</h2>
        <p>
        ...
        <p><b>Related:</b> <a hhref="#Personal_Honor">Personal Honor and Dishonor</a>,
            <a hhref="#Glory_Count">Glory Count</a></p>
        <h2 id="Glory_Count">Glory Count</h2>
        <p>
        ...
        <ul>
            <li><a hhref="#Conflict_Phase">Step 3.4.1</a>
        ...
        <p><b>Related:</b> <a hhref="#Imperial_Favor">Imperial Favor</a></p>
        ...
        <p>For holding card anatomy, see "<a hhref="#Appendix_II">Appendix II: Card Anatomy</a>" on page 24.</p>
        <h2 id="Home">Home, Move Home</h2>
        <p>
        ...
        <p>
            Honor represents the behavior of a player's clan, and the outward perception of that behavior. It is bid during the draw phase (see framework step "<a
                hhref="#Draw_Phase">2.2. Honor bid</a>" on page 20) and during duels. Honor also serves as a victory track to measure an honor win or an honor loss. The amount of honor a player has at any given time is represented (as open information) by honor tokens in his or her honor pool.
        </p>
        <ul>
        ...
        <p><b>Related:</b> <a hhref="#Winning_the_Game">Winning the Game</a></p>
        <h2 id="Honored">Honored, Honored Status Token</h2>
        <p>See "<a hhref="#Personal_Honor">Personal Honor</a>" on page 12.</p>
        ...
        <h2 id="Imperial_Favor">Imperial Favor, Imperial Favor Contest</h2>
        <p>The Imperial Favor represents which player currently holds the favor of the Emperor. <a
                hhref="#Conflict_Phase">Step 3.4.1</a>
            of the conflict phase consists of a framework glory count. The winner of this count claims the Imperial Favor and may set it to either side.
        </p>
        <ul>
            <li>
        ...
        <p><b>Related:</b> <a hhref="#Glory_Count">Glory Count</a></p>
        ...
        <p><b>Related:</b> <a hhref="#Enters_Play">Enters Play</a>,
            <a hhref="#Leaves_Play">Leaves Play</a>,
            <a hhref="#Play_and_Put_into_Play">Play and Put Into Play</a></p>
        <h2 id="Influence">Influence, Influence Cost</h2>
        <p>
        ...
        <h2 id="Initiating_Abilities">Initiating Abilities / Playing Cards</h2>
        <p>
        ...
        <p>A keyword is a card ability which conveys specific rules to its card. The keywords in the core set are:	<a
                hhref="#Ancestral">Ancestral</a>,
            <a hhref="#Courtesy">Courtesy</a>,
            <a hhref="#Covert">Covert</a>,
            <a hhref="#Limited">Limited</a>,
            <a hhref="#No Attachments">No Attachments</a>,
            <a hhref="#Pride">Pride</a>,
            <a hhref="#Restricted">Restricted</a>, and
            <a hhref="#Sincerity">Sincerity</a>.</p>
        <ul>
            <li>
        ...
        <h2 id="Limit_X_per_period">Limit X per [period]</h2>
        <p>
        ...
        <p><b>Related:</b> <a hhref="#Max_X_per_period">Max X per [period]</a></p>
        <h2 id="Max_X_per_period">Max X per [period]</h2>
        <p>
        ...
        <p><b>Related:</b> <a hhref="#Limit_X_per_period">Limit X per [period]</a></p>
        <h2 id="May">May</h2>
        <p>
        ...
        <h2 id="Nested_Ability_Sequences">Nested Ability Sequences</h2>
        <p>
        ...
        <h2 id="No Attachments">No Attachments</h2>
        <p>
        ...
        <h2 id="Ownership">Own, Ownership</h2>
        <p>See "<a hhref="#Control_and_Ownership">Control and Ownership</a>" on page 4.</p>
        <h2 id="Participating">Participating and Cannot Participate</h2>
        <p>
        ...
        <h2 id="Personal_Honor">Personal Honor, Personal Dishonor</h2>
        <p>
        ...
        <h2 id="Play_and_Put_into_Play">Play and Put into Play</h2>
        ...
        <h2 id="Play_Restrictions_and_Permissions">Play Restrictions and Permissions</h2>
        <p>
        ...
        <h2 id="Provinces">Provinces, Province Cards</h2>
        <p>
        ...
        <h2 id="Refill_a_Province">Refill a Province</h2>
        <p>
        ...
        <h2 id="Replacement_Effects">Replacement Effects</h2>
        <p>
        ...
        <h2 id="Resolve_twice">"Resolve this ability twice"</h2>
        <p>See "<a hhref="#Initiating_Abilities">Initiating Abilities / Playing Cards</a>" on page 9.</p>
        ...
        <p><b>Related:</b> <a hhref="#Ring_Effects">Ring Effects</a></p>
        <h2 id="Ring_Effects">Ring Effects</h2>
        <p>
        ...
        <ul>
            ...
            <li>Cards with the printed role cardtype cannot be removed from the game by other card abilities.</li>
            <li>
        ...
        <h2 id="Running_Out_of_Cards">Running Out of Cards</h2>
        <p>
        ...
        <p><b>Related:</b> <a hhref="#Initiating_Abilities">Initiating Abilities</a></p>
        <h2 id="Self-referential_Text">Self-referential Text</h2>
        <p>
        ...
        <ol>
            <li><b>Select decks</b>. Each player selects a deck using the deckbuilding rules. See "<a
                    hhref="#Deckbuilding">Deckbuilding</a>" on page 5.
            </li>
        ...
        <h2 id="Status_Token">Status Token</h2>
        <p>See <a hhref="#Personal_Honor">Personal Honor</a> on page 12.</p>
        ...
        <h2 id="Token_Pool">Token Pool, General Token Pool</h2>
        <p>
        ...
        <p><b>Related:</b> <a hhref="#Ability">Ability</a>,
            <a hhref="#Action">Action</a>,
            <a hhref="#Cost">Cost</a>,
            <a hhref="#Effect">Effect</a>,
            <a hhref="#Interrupts">Interrupts</a>,
            <a hhref="#Reactions">Reactions</a>,
            <a hhref="#Target">Target</a></p>
        ...
        <p><b>Related:</b> <a hhref="#Duplicates">Duplicates</a></p>
        <h2 id="Unopposed">Unopposed, Unopposed Conflict</h2>
        <p>
        ...
        <ul>
            <li>
                Each time the defending player loses an unopposed conflict, that player loses 1 honor. The lost honor is returned to the general token pool. This occurs during framework <a
                    hhref="#Conflict_Phase">step 3.2.4</a>.
            </li>
        </ul>
        <h2 id="Winning a Conflict">Winning a Conflict</h2>
        <p>
        ...
        <h2 id="Winning_the_Game">Winning the Game</h2>
        <p>
        ...
        <h1 id="Appendix_I">Appendix I: Timing and Gameplay</h1>
        <p>
        ...
        <h2 id="Framework_Steps">Framework Steps</h2>
        ...
        <h2 id="Action_Windows">Action Windows</h2>
        ...
        <h2 id="Reactions_and_Interrupts">Reactions and Interrupts</h2>
        <p>
        ...
        <h2 id="Phase_Sequence_Timing_Chart">Phase Sequence Timing Chart</h2>
        <table class="chart">
            <tr>
        ...
        <h3>1.2. Reveal facedown dynasty cards</h3>
        <p>
        ...
        <h3>1.4. Play cards from provinces</h3>
        <p>
        ...
        <h2 id="Draw_Phase">2. Draw Phase</h2>
        <h3>2.1. Draw phase begins</h3>
        ...
        <h3>2.6. Draw phase ends</h3>
        <p>This step formalizes the end of the draw phase.</p>
        <h2 id="Conflict_Phase">3. Conflict Phase</h2>
        <h3>3.1. Conflict phase begins</h3>
        <p>This step formalizes the beginning of the conflict phase.</p>
        <h3>3.2. Declare conflict</h3>
        ...
        <ul>
            <li>Declare a military conflict, or pass the opportunity to do so.</li>
            <li>Declare a political conflict, or pass the opportunity to do so.</li>
        </ul>
        <p>
            If a specific conflict opportunity is passed, the player forfeits his or her right to use that opportunity this phase.</p>
        ...
        <h3>3.2.2. Conflict action window</h3>
        <p>
        ...
        <h3>3.2.3. Compare skill values</h3>
        <p>
        ...
        <p>If the defending player or no player won the conflict, nothing happens during this step.</p>
        <h3>3.2.6. Resolve ring effects</h3>
        <p>
        ...
        <h3>3.3. Conflict ends / Conflict was passed</h3>
        <p>
        ...
        <h3>3.4.2. Claim Imperial favor</h3>
        <p>
        ...
        <h3>3.5. Conflict phase ends</h3>
        <p>This step formalizes the end of the conflict phase.</p>
        <h2 id="Fate_Phase">4. Fate Phase</h2>
        <h3>4.1. Fate phase begins</h3>
        <p>This step formalizes the beginning of the fate phase.</p>
        <h3>4.2. Discard characters with no fate</h3>
        <p>
        ...
        <h3>D.2. Establish challenger and challengee</h3>
        <p>
        ...
        <h3>D.4. Reveal honor dials</h3>
        <p>The players simultaneously reveal their bids.</p>
        <p>
            Once a player reveals an honor bid, the dial is placed next to the player's stronghold and remains as a reference point until the next honor bid occurs.</p>
        <h3>D.5. Transfer honor</h3>
        <p>
            The player with the higher honor bid must give an amount of honor to the player with the lower honor bid that is equal to the difference between the two bids. If the bids are equal, no honor is transferred during this step.</p>
        <h3>D.6. Modify dueling skill</h3>
        <p>
        ...
        <h3>D.7. Compare skill values and determine result</h3>
