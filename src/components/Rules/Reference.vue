<template>
    <div class="row">
        ...
        <div class="contents order-sm-1 col-sm-8 mt-3">
            ...
            <p>New entries and changes from previous editions will be noted in this space. Changes noted in <span
                    class="new">red text</span>.</p>
            <p><a href="#breaking-a-province-broken-province">Breaking a Province</a>, 
			<a href="#current">Current</a>, 
			<a href="#dash">Dash</a>, 
			<a href="#deck_limits">Deck Limits</a>, 
			<a href="#facedown_province">Facedown Provinces</a>, 
			...
			<a href="#appendix-iii-faq">Appendix III: FAQ</a>, 
			<a href="#appendix-iv-errata">Appendix IV: Errata</a></p>
            <hr>
            ...
            <p><b>Related:</b> <a href="#cost">Cost</a>,
            ...
            <p>
                If an ability causes a card's printed text box to be considered "blank," that text box is treated as if it did not have any of its printed <em>Traits<em>
            ...
            <ul>
                ...
                <li>
                    If three of a player's non-stronghold provinces are broken, <span class="new">that player's stronghold becomes an eligible province against which attacks may be made</span>. If a player's stronghold province is broken, that player loses the game.
                </li>
				<li>
            ...
            <p>
                Some card abilities can "cancel" other card or game effects. Cancel abilities interrupt the initiation of an effect, and prevent the effect from initiating. Because of this, cancel abilities have timing priority over <em>all<em>
            ...
            <p><b>Related:</b> <a href="#deckbuilding">Deckbuilding</a></p>
            ...
            <p>
                If a character has a dash (&ndash;) for a skill value, that character cannot participate in, <span class="new">be played into, or be put into play in</span> conflicts of that type.</p>
            <ul>
                <li>
                ...
                <li>
                    A character with a dash skill value cannot be a challenger or challengee in a duel of that skill type. (see <a
            ...
            <ul>
                ...
                <li>
                    A player's conflict deck must contain a minimum of 40 and a maximum of 45 cards. Each of these cards must be in-clan, be neutral, or be purchased from a <b>single</b>
                    other clan by using influence.
                </li>
                <ul>
                    <li>
                        A player's stronghold indicates the amount of influence that player may spend during deckbuilding.
                    </li>
                ...
                <li>
                    A player's set of provinces must include exactly 5 provinces, consisting of exactly 1 province associated with each ring. (Each province has a ring symbol in the lower right corner of the card to indicate its association.) Each of these provinces must be in-clan or be neutral.
                </li>
                <ul>
                    <li>
            ...
            <p>
                If a card has the text "<span class="new">Limit X per deck</span>" no more than X copies of that card may be included in that player's dynasty and/or conflict decks.</p>
            <ul>
            ...
            <ul>
                ...
                <li>
                    When a delayed <span class="new">effect</span> resolves, it is still considered to be an ability originating from the cardtype of the card that created the delayed effect.
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    When an event card is played, its costs are paid, its effects are resolved (or canceled), and it is placed in its owner's discard pile prior to opening the reaction window which follows the ability's resolution.
                </li>
                <li>
            ...
            <ul>
                ...
                <li>A player may look at the facedown provinces under his or her control at any time. <b>Note:</b>
                    this rule refers to the facedown province card itself. A player is not permitted to look at facedown dynasty cards in his or her provinces.
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    Whenever a player plays a character from his or her hand or provinces, after paying the character's cost, that player has the option of placing any number of fate from his or her fate pool onto that character.
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    For any question as to who should perform an act or make a decision first, in the absence of any other direction by card or rules text, the first player does so first, followed by the opponent.
                </li>
            </ul>
            <p><b>Related:</b> <a href="#active-player">Active Player</a>,
                <a href="#setup">Setup</a>,
            ...
            <ul>
                <li>
                    The +1 skill modifier granted by the Imperial Favor applies to any conflict of the specified type in which its bearer controls at least one participating character. This modifier applies to the <em>player's<em>
                    total skill that is counted for the conflict, but does not modify the skill value of any of the characters participating in the conflict.
                </li>
                <li>
            ...
            <p>
                "Out-of-play" refers to all other cards and areas involved in the game environment, including: character cards in a player's provinces, role cards, cards in a player's hand, decks, discard piles, and any cards that have been removed from the game.</p>
            <ul>
            ...
            <ul>
                <li>
                    A player may spend influence up to the amount indicated by his or her stronghold to include out-of-clan cards from a <em>single<em>
            ...
            <ol>
                <li>
                    Check play restrictions and verify the existence of eligible targets: can the card be played, or the ability initiated, at this time? If the play restrictions are not met, or there are no eligible targets for the ability, the process cannot proceed.
                </li>
                <li>
            ...
            <p>Once each of the preliminary confirmations has been made, follow these steps, in order:</p>
            <ol start="3">
                ...
                <li>
                    The card attempts to enter play, or the effects of the ability attempt to initiate. An interrupt ability that cancels this initiation may be used at this time. <span class="new">At this time the card is considered "played" or the ability "triggered."</span>
                </li>
                <li>The effects of the ability (if not canceled in step 6) complete their initiation, and resolve.</li>
            </ol>
            <p>
                Interrupts and reactions may be used throughout this process as normal, should their triggering conditions occur.</p>
            <ul>
                <li>
                    If an ability instructs a player to "resolve this ability twice," repeat steps 5&ndash;7 of this process immediately after the first resolution of the ability's effect (i.e., resolve the ability again before any reactions to the first resolution of the effect may be triggered). Costs are not paid a second time when an ability is resolved twice.
                </li>
            </ul>
            <p><b>Related:</b> <a href="#ability">Ability</a>,
                <a href="#cost">Cost</a>,
            ...
            <p>
                Unlike actions, which are resolved during action windows, an interrupt may be initiated only if its specified triggering condition occurs, as described in the interrupt ability's text.</p>
            <p>
                When a triggering condition initiates (but before it completes its resolution), an interrupt window for that triggering condition opens.</p>
            <p>
                Within the interrupt window, the first player always has the first opportunity to initiate an eligible interrupt (to the triggering condition that opened the window), or pass. Opportunities to initiate an eligible interrupt, or pass, continue to alternate between the players until all players consecutively pass, at which point the interrupt window closes. Passing does not prevent a player from initiating an eligible interrupt later in that same interrupt window.</p>
            <p>
                Once an interrupt window closes, further interrupts to that specific triggering condition cannot be initiated. The triggering condition now completes its resolution (as long as its effects have not been canceled).</p>
            <ul>
                <li>
            ...
            <p>A keyword is a card ability which conveys specific rules to its card. The keywords in the core set are:	
                ...
                <a href="#sincerity">Sincerity</a>.</p>
            <ul>
                <li>
            ...
            <p>
                Any time a new modifier is applied (or removed), the entire quantity is recalculated from the start, considering the unmodified base value and all active modifiers.</p>
            <ul>
                <li>
            ...
            <ul>
                <li>If one or more traits precedes the word "attachments" (for example, "No <em>Weapon<em>
                    or <em>Armor<em>
                ...
                <li>
                    If the word "attachments" is followed by the word "except" and one or more traits (for example, "No attachments except <em>Weapon<em>"), the card can have attachments that possess one or more of the specified traits, but it cannot have attachments possessing none of those traits.
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    If a character "cannot participate" in a conflict, that character cannot be declared as an attacker or defender for, move into, be played into, <span class="new">or put into play in</span> that conflict. If an already participating character gains "cannot participate" status during a conflict, move it home bowed.
                </li>
            </ul>
            ...
            <p>
                Characters enter play with ordinary status. Honored status tokens and dishonored status tokens are used to track the state of a character that receives a status other than ordinary.</p>
            <ul>
                <li>
                ...
                <li>
                    When a character is dishonored, it receives a dishonored status token to indicate its dishonored status. A dishonored character subtracts its glory value from both its military and political skill so long as it possesses that token. When a dishonored character leaves play its controller loses 1 honor.
                </li>
                <li>
            ...
            <ul>
                ...
                <li>In order to <em>play<em> a card, its fate cost (after modifiers) must be paid.</li>
                <li>When a card is <em>put into play<em>, its fate cost is ignored.</li>
                <li>
            ...
            <ul>
                <li>A face-down province card is considered to be in play only as a face down province, and its faceup side is unable to engage with the game state until the province is revealed.                </li>
				...
				<li><span class="new">If a province has more than one card in it, those cards are considered to all be in the same province. Characters can be played and holdings provide their bonuses. Do not refill a province until it is empty.</span></li>
            </ul>
            ...
            <ul>
                ...
                <li>When a ring becomes the contested ring in a conflict, move all fate on that ring to the attacking player's fate pool.</li>
				<li><span class="new">When a ring is claimed, it is still considered to be contested until all reactions to its claiming have resolved.</span></li>
            </ul>
            ...
            <p><b>Earth</b>: The attacking player draws 1 card from his or her conflict deck and discards 1 card at random from his or her opponent's hand.
            </p>
            <p><b>Fire</b>: The attacking player chooses a character in play and chooses to honor or dishonor that character.
            </p>
            <p><b>Water</b>: The attacking player either chooses a character and readies it, or chooses a character with no fate on it and bows it.
            </p>
            ...
            <ul>
                ...
                <li>Cards <span class="new">that are printed as the</span> role card type cannot be removed from the game by other card abilities.</li>
                <li>
                    In sanctioned tournament play, role card eligibility for each clan is determined by the <span class="new"> Clan Roles webpage found at: <a href="https://www.fantasyflightgames.com/en/op/l5r-lcg/roles/" target="_blank">https://www.fantasyflightgames.com/en/op/l5r-lcg/roles/</a></span>
                </li>
				<li>
            ...
            <ul>
                <li>If the selected card does not leave play, the sacrifice is <span class="new">considered to have been prevented</span>.</li>
            ...
            <ul>
                <li>
                    If an effect searches an entire deck, the deck must be shuffled to the satisfaction of the opponent upon completion of the search.
                </li>
                <li>
            ...
            <ul>
                <li>
                    If a selection is required before the effect of the ability resolves (i.e., before the dash), the selection is made during the same timing step in which targets are chosen.
                </li>
                <li>
                    If a selection is indicated after the dash of an ability's text, that selection is made during the resolution of the effect.
                </li>
                <li>
                    Unless otherwise indicated by the ability, the controller of the ability is the player who makes the selection.
                </li>
                <li>
            ...
            <p>
                <span class="new">See "<a href="#modifiers">Modifiers</a>" on page 11.</span></p>
            ...
            <ol>
                ...
                <li><b>Create token bank and unclaimed ring pool</b>. Place all fate tokens, honor tokens, status tokens, and the Imperial Favor in a pile within reach of each player. This area is known as the token bank. Place the rings near the token bank. This area is known as the unclaimed ring pool.
                </li>
                <li><b>Determine first player</b>. Randomly select a player. That player will be the first player. Place the first player token in front of this player. The player that is not randomly selected to be the first player gains 1 fate from the general token pool and adds it to their fate pool.
                </li>
                <li><b>Shuffle dynasty and conflict decks</b>. Each player shuffles both their dynasty and conflict decks separately and presents them to the opponent for additional shuffling and/or a final cut. Then each player places their dynasty deck to the left of their play area and their conflict deck to the right.
                </li>
                ...
                <li><b>Fill provinces</b>. Each player places a card from the top of their dynasty deck facedown onto each of their empty non-stronghold provinces. In player order, each player <span class="new">looks at each of his or her cards placed in this manner and has one opportunity to</span> mulligan any number of them.
                </li>
                <ul>
                    <li><b>Note:</b> After this step, a player may not look at facedown cards in his or her provinces.
                    </li>
                </ul>
                <li><b>Draw starting hand</b>. Each player draws 4 cards from their conflict deck. In player order, each player has one opportunity to mulligan any number of these cards.
                </li>
                <li><b>Gain starting honor</b>. Each player gains honor tokens equal to the honor value on their stronghold.
                </li>
            </ol>
            ...
            <ul>
                <li>
                    Total attacking skill is the sum of each ready participating character's skill (for the appropriate conflict type) on the attacking player's side, plus any relevant modifiers.
                </li>
                <li>
                    Total defending skill is the sum of each ready participating character's skill (for the appropriate conflict type) on the defending player's side, plus any relevant modifiers.
                </li>
                <li>
                    A player is not able to win a conflict if that player has a total attacking or defending skill of zero.
                </li>
            </ul>
            <p>
                <em>A character's printed military skill can be found at the top of the banner beneath the cost, in red.</em>
            </p>
            <p>
            ...
            <ul>
                ...
                <li>
                    At the time targets are chosen, any currently valid targets are eligible to be chosen. (This choice is not restricted only to targets that were present during the initiation check.)
                </li>
            ...
            <ul>
                <li>
                    When a player gains fate or honor, that fate or honor is taken from the token pool and added to that player's fate or honor pool. When a player spends or loses fate or honor, those tokens are returned to the token pool.
                </li>
                <li>
            ...
            <p>Most cards have one or more traits listed at the top of the text box and printed in <em>Bold Italics<em>.
            </p>
            <ul>
                <li><em>Traits<em>
            ...
            <ul>
                <li>
                    Unless the timing command is prefaced by the word "Forced," all triggered abilities are optional. They can be triggered (or not) by their controller at the ability's appropriate timing point. Forced triggered abilities are triggered automatically by the game at the ability's appropriate timing point.
                </li>
                <li>
                    Unless otherwise specified by the ability itself, each triggered ability may be triggered once per round.
                </li>
                <li>Triggered abilities are written in a <em>"triggering condition (and/or) cost (and/or) targeting requirements &ndash; effect"</em>
                    template. Ability text before the dash consists of triggering conditions (and/or) costs (and/or) targeting requirements. Ability text after the dash consists of effects. and may sometimes include targeting requirements that come into play as the effect is being resolved.
                </li>
                <li>
                ...
                <li>
                    A triggered ability can only be initiated if its effect has the potential to change the game state on its own. This potential is assessed without taking into account the consequences of the cost payment or <span class="new">the consequences of</span> any other ability interactions.
                </li>
                <li>
            ...
            <p>
                If a single occurrence creates multiple triggering conditions (such as a single Earth ring effect causing a player to draw a card and another player to discard a card), those triggering conditions are handled in shared interrupt/reaction windows, in which abilities that refer to any of the triggering conditions created by that occurrence may be used in any order.</p>
            <p>
                The following is a sequence of possible interrupt and reaction opportunities that exists around each triggering condition that may arise in a game:</p>
            <ol>
                <li>
                    The triggering condition becomes imminent. (In other words, if it is not canceled, changed, or otherwise preempted by interrupt abilities, the triggering condition is the next thing that will occur in the game.)
                </li>
                <li>
                    Interrupt abilities that reference when the imminent triggering condition "would" occur may be used. (<b>Note</b>: For effects, a "cancel" interrupt may prevent the effect from initiating, and the initiation of the effect is a separate triggering condition that precedes the effect's resolution. "Cancel" interrupts are the only type that will reference the initiation of an effect.) If the imminent triggering condition is canceled, none of the subsequent steps in this sequence occur. If the triggering condition is changed, the original condition is no longer imminent, but the new triggering condition is now imminent.
                </li>
                <li>
                    Forced interrupts that reference the imminent triggering condition must resolve, in the order determined by the first player. The standard interrupt window to the imminent triggering condition opens. It closes after all players consecutively pass.
                </li>
                <li>The triggering condition itself occurs.</li>
                <li>
                    Forced reactions that reference the triggering condition must resolve, in the order determined by the first player.
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    As a player action during the dynasty phase, a player may discard a copy (by title) of a unique character from his or her hand or provinces to place 1 fate on an in-play copy of that unique character he or she controls.
                </li>
            </ul>
            ...
            <ul>
                <li>
                    Each time the defending player loses an unopposed conflict, that player loses 1 honor. The lost honor is returned to the general token pool. This occurs during framework <a
            ...
            <ul>
                <li>
                    A player's total skill is the sum of the skill matching the conflict type of each ready participating character on his or her side of the conflict, along with any other modifiers that are affecting the amount of skill the player counts for the conflict.
                </li>
                <li>
                ...
                <li>
                    If the total skill counted on each side is tied at a value of 1 or greater (and the attacking player controls at least one participating character), the attacking player wins the conflict.
                </li>
                <li>
                    If neither player can meet the requirements of winning a conflict, neither player wins (or loses) that conflict. When this occurs, return the contested ring to the unclaimed ring pool.
                </li>
                <li>
                    Some card abilities reference a character "winning" a conflict. In order for a character to be considered to have "won" a conflict, that character must be participating in the conflict on the winning side at the time the ability resolves.
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    The first player to meet the condition of having 25 or more honor in his or her honor pool wins the game.
                </li>
                <li>
                    The first player to have 0 honor in his or her honor pool is eliminated from the game, causing that player's opponent to win.
                </li>
                <li>
            ...
            <p>
                All "would be X" interrupts are eligible to be used before any "is X" interrupts. This means that an interrupt with the word "would" (such as "when a character would leave play") has timing priority over an interrupt without the word "would" that references that same occurrence (such as "when a character leaves play").</p>
            <ul>
                <li>
            ...
            <p>Numbered (or lettered) items presented in the darker <em>grey<em>
                boxes are known as framework steps. Framework steps are mandatory occurrences dictated by the structure of the game. <em>Purple<em>
            ...
            <p>An action ability may only be triggered during an action window. Action windows are presented in lighter <em>orange<em>
            ...
            <table class="chart">
                ...
                <tr>
                    <td><b>3.2</b> Next player in player order declares a conflict (go to <b>Conflict Resolution</b>), or passes (go to (<b>3.3</b>).
                    </td>
                </tr>
                <tr>
            ...
            <p><b>NOTE</b>: During this window, a player is not permitted to play character or attachment cards from his or her hand.
            </p>
            <p>
			...
			<p>If a conflict opportunity is passed, the player forfeits his or her right to use that opportunity this phase.</p>
            </span>
            ...
            <p>
                If a player selects an unclaimed ring with fate on it to become the contested ring, that fate is moved from the ring to the attacking player's fate pool.</p>
            <ul>
                <li>Declare which <em>ready<em>
                    characters (under his or her control) are being committed as attackers. The attacking player may declare any number of eligible characters under his or her control as attackers. Slide these characters toward the center of the play area, away from the attacking player's home area. At least one character must be declared as an attacker at this time in order to initiate a conflict. If any of the attackers have the covert keyword, the targets for covert are chosen at this time.
                </li>
            </ul>
            <p>
                Each of the above items are considered to be performed simultaneously. If any of the above cannot be completed, the conflict cannot be initiated.</p>
            <p>
            ...
            <ul>
                ...
                <li>
                    Play a character from hand, into the conflict, participating on that player's side. (Additional fate from the player's fate pool may be placed on the character at this time.)
                </li>
                <li>
                    Play a character from hand into his or her home area. (Additional fate from the player's fate pool may be placed on the character at this time.)
                </li>
                <li>Pass.</li>
            </ul>
            <p>
            ...
            <p><b>Water</b>: The attacker either chooses a character and readies it, or chooses a character with no fate on it and bows it.
            </p>
            <p><b>Void</b>: The attacking player chooses a character and removes 1 fate from that character.</p>
            <p>If the defending player or no player won the conflict, nothing happens during this step.</p>
            ...
            <ol>
                ...
                <li><b>Bonus Military Skill</b>: The bonus value this card provides to the attached character's military skill.
                </li>
                <li><b>Political Skill</b>: The character's political skill value.</li>
                <li><b>Bonus Political Skill</b>: The bonus value this card provides to the attached character's political skill.
                </li>
                ...
                <li><b>Bonus Strength</b>: The bonus strength provided to a province or stronghold if this holding is in it.
                </li>
			...
			<p>This section provides answers to a number of common questions that are asked about the game. The entries are presented in a "question and answer" format, with the newest questions at the end of the list.</p>
			<ul>
			<li><em>Can I trigger <a href="https://fiveringsdb.com/card/shameful-display" target="_blank">Shameful Display</a> (Core, 24) if only one of the two chosen characters would change their honored status?<em></li>
			</ul>
			<p>Yes. The rules state that you cannot trigger an ability if its effect would fail to change the game state, but one of the chosen characters is changing their status so a game state change occurs. Neither the honoring nor the dishonoring aspect of Shameful Display is dependent upon the other.</p>
			<ul>
			<li><em>Can I trigger the ability of <a href="https://fiveringsdb.com/card/akodo-toturi" target="_blank">Akodo Toturi</a> (Core, 79) or <a href="https://fiveringsdb.com/card/doji-hotaru" target="_blank">Doji Hotaru</a> (Core, 52) when I win a corresponding challenge as the defender?<em></li>
			</ul>
			<p>You can trigger the ability as the defender, but per <a href="#ring-effects">RRG "Ring Effects"</a>, resolving the ring's effect instructs the attacking player to choose a target, draw cards, or gain honor. Your opponent would resolve the ring's effect, not you.</p>
			<ul>
			<li><em>If I play <a href="https://fiveringsdb.com/card/let-go" target="_blank">Let Go</a> (Core, 155) targeting my opponent's <a href="https://fiveringsdb.com/card/watch-commander" target="_blank">Watch Commander</a> (Core, 133), does my opponent get to trigger their Watch Commander before it goes to the discard pile?<em></li>
			</ul>
			<p>Yes. A card is considered to have been played when it reaches step 6 of the process of initiating abilities (see <a href="#initiating-abilities-playing-cards">RRG "Initiating Abilities / Playing Cards"</a>). The effects of an event resolve at step 7. Therefore, when you play Let Go targeting your opponent's Watch Commander, they will react to you playing Let Go before you resolve its effects.</p>
			<ul>
			<li><em>Can I use <a href="https://fiveringsdb.com/card/reprieve" target="_blank">Reprieve</a> (Core, 132) to prevent a character from being sacrificed for a cost, such as that of <a href="https://fiveringsdb.com/card/shosuro-actress" target="_blank">Shosuro Actress</a> (Core, 103) or <a href="https://fiveringsdb.com/card/steadfast-witch-hunter" target="_blank">Steadfast Witch Hunter</a> (Core, 35)? What about <a href="https://fiveringsdb.com/card/way-of-the-crab" target="_blank">Way of the Crab</a> (Core, 137)?<em></li>
			</ul>
			<p>Reprieve will prevent a character from being sacrificed. If that occurs during the payment of a cost (Actress, Witch Hunter, Way of the Crab, etc.) then that cost is not considered to have been paid as the sacrifice was prevented (see <a href="#sacrifice">RRG "Sacrifice"</a>). However, this occurs during step 4 of the process of initiating abilities (<a href="#initiating-abilities-playing-cards">RRG "Initiating Abilities / Playing Cards"</a>), which is before step 6 when the game determines whether an ability has been triggered. Therefore, because the ability is not considered to have been used, it could be triggered again in the next available action window. If an event is canceled in this way, it will remain unplayed in its owner's hand (<a href="#cost">RRG "Cost"</a>).</p>
			<p>This is different from using Reprieve to prevent a character from being sacrificed to Way of the Crab's effect. Because nothing is dependent upon whether or not the effect of Way of the Crab resolved successfully, it does not matter that the sacrifice was prevented by Reprieve. In the same way that an event whose effects were canceled by <a href="https://fiveringsdb.com/card/voice-of-honor" target="_blank">Voice of Honor</a> (Core, 145) is still considered to have been played, Way of the Crab is still considered to have "resolved" (albeit unsuccessfully) even if its effect is prevented by Reprieve.</p>
			<ul>
			<li><em>If my opponent plays <a href="https://fiveringsdb.com/card/banzai" target="_blank">Banzai!</a> (Core, 204) and I wish to cancel it with <a href="https://fiveringsdb.com/card/voice-of-honor" target="_blank">Voice of Honor</a> (Core, 145), can I cancel the whole effect, or just half of it?<em></li>
			</ul>
			<p>When your opponent plays Banzai!, they will select a target to receive +2<span class="icon icon-conflict-military"></span>. You may interrupt to cancel this effect, which would also cancel the option to repeat the ability. If you do not, and they choose to pay 1 honor to resolve the ability again, then you have another opportunity to interrupt to cancel the (new) set of effects that give +2<span class="icon icon-conflict-military"></span> to a character. Thus, you can choose to cancel either the entire card effect, just the second part of the card effect, or none of the card effect.</p>
			<ul>
			<li><em>Can I play <a href="https://fiveringsdb.com/card/way-of-the-crab" target="_blank">Way of the Crab</a> (Core, 137) during the Dynasty Phase?<em></li>
			</ul>
			<p>Yes. During the Dynasty Phase, you may play a character from a province or take an action, which includes playing events from your hand.</p>
			<ul>
			<li><em>How does <a href="https://fiveringsdb.com/card/display-of-power" target="_blank">Display of Power</a> (Core, 179) interact with cards such as <a href="https://fiveringsdb.com/card/seeker-of-knowledge" target="_blank">Seeker of Knowledge</a> (Core, 171) and <a href="https://fiveringsdb.com/card/pilgrimage" target="_blank">Pilgrimage</a> (Core, 22)?<em></li>
			</ul>
			<p>Display of Power is played during step 3.2.3 of conflict resolution, when the defending player loses the conflict (see <a href="#3-2-3-compare-skill-values">RRG "3.2.3. Compare skill values"</a>). It produces a delayed effect that takes place during step 3.2.6, "Resolve Ring Effects" that cancels the normal effects of ring resolution and replaces it with "resolve the ring effect as if you had won the conflict as the attacking player." Losing honor for unopposed and breaking the province will occur before resolving Display of Power's effect.</p>
			<p>Should the Pilgrimage province not be broken when Display of Power resolves, the delayed effect of Display takes precedence over Pilgrimage, canceling the normal resolution of Resolve Ring Effects and replacing it with the adjusted means of resolution. However, the Pilgrimage effect ("cancel all ring effects") still cancels the Display of Power's attempt to resolve the ring for the defender. The defender claims the ring.</p>
			<p>Because Display of Power interacts with the Resolve Ring Effects step rather than the specific effect chosen by the attacker, the attacker does not have the option to choose a specific ring effect to resolve when Seeker of Knowledge is attacking (or whether they would like to resolve a ring effect at all). When Display of Power resolves the ring effect, the defender has the opportunity to choose which ring effect they would like to resolve instead.</p>
			<ul>
			<li><em>If <a href="https://fiveringsdb.com/card/steward-of-law" target="_blank">Steward of Law</a> (Core, 139) is in a conflict, can an honored character be dishonored?<em></li>
			</ul>
			<p>Yes. Steward of Law prevents characters from "becoming dishonored," which means "gaining the dishonored status token." Most of the time this occurs through the act of dishonoring, but it would also prevent the use of an ability that moved or placed a dishonored status token. If a character could be dishonored without gaining a dishonored token (such as an honored character being dishonored and returning to ordinary state), they will still do so.</p>
			<ul>
			<li><em>If I play <a href="https://fiveringsdb.com/card/way-of-the-lion" target="_blank">Way of the Lion</a> (Core, 167) to double my character's base <span class="icon icon-conflict-military"></span> skill, and then play a second Way of the Lion, what is my character's new base <span class="icon icon-conflict-military"></span> skill?<em></li>
			</ul>
			<p>Way of the Lion doubles a character's base <span class="icon icon-conflict-military"></span> skill and sets it to the new value. When you play a second copy of Way of the Lion, the new value will be doubled (to now be quadruple the original skill value).</p>
			<ul>
			<li><em>If I use <a href="https://fiveringsdb.com/card/origami-master" target="_blank">Origami Master</a>'s ability (Imperial Cycle, 84) to move an honored status token to another character, is that character being honored? Does it allow <a href="https://fiveringsdb.com/card/savvy-politician" target="_blank">Savvy Politician</a>'s ability (Core, 45) to trigger?<em></li>
			</ul>
			<p>If a character gains an honored status token through a card effect, it is "becoming honored," (gaining the honored status) which is different from "being honored" (going through the process of honoring). This will not trigger effects such as that of Savvy Politician or <a href="https://fiveringsdb.com/card/young-rumormonger" target="_blank">Young Rumormonger</a> (Core Set, 101).</p>
			<p>Note: If a character has both an honored status token and a dishonored status token, both are discarded and the character is returned to an ordinary state. See <a href="#personal-honor-personal-dishonor">RRG "Personal Honor, Personal Dishonor"</a>.</p>
